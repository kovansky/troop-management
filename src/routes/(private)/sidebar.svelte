<script lang="ts">
	...
	export let links = [
		...
		{ name: 'Ewidencja', url: '/people', svg: ['M4 6h16M4 10h16M4 14h16M4 18h16'] },
		{ name: 'Składki i opłaty', url: '/fees', svg: ['M4 6h16M4 10h16M4 14h16M4 18h16'] },
		{
			name: 'Pages',
			url: '/pages',
			svg: [
		...
		{#each links as link, a}
			<li class="relative px-6 py-3">
				...
				{:else}
					...
					{#if $pageMenu[link.name] || isChildLink(link)}
						<ul

				...
				<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
					<div>
						...
						<div class="flex w-3/4 mt-4 relative z-0">
							<div
								class="absolute z-10 hover:bg-neutral-focus items-center flex-col gap-y-2 flex w-3/4 h-full opacity-0 hover:opacity-100 justify-center"
							>
								<button
							...
							<div class="avatar placeholder w-3/4 z-0">
...
<dialog id="file_modal" class="modal">
	...
	<div class="border rounded-lg shadow relative max-w-2xl modal-box">
		...
		<div class="p-6 pt-0 text-center">
			...
			<div class="mt-4">
				<form on:submit|preventDefault={uploadAvatar} id="avatar-form">

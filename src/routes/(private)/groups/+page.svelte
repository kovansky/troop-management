...
<MainPage
	title="Grupy i zastępy"
	subtitle="Lista zastępów i grup nieformalnych w jednostce"
	gotoUrl="/groups/group_details"
	buttonName="Dodaj grupę/zastęp"
>
	<TableView labelList={['Nazwa', 'Opis']}>
		{#each data.groups as group}
			...
			>
				...
				<td class="text-sm">{group?.description || 'Brak opisu'}</td>
			</tr>
		{/each}
	</TableView>
</MainPage>
